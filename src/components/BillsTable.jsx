            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {bills.map((bill) => (
                <tr key={bill.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ₹{Number(bill.basePrice).toFixed(2)}/kg
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {bill.discountPerKg
                      ? `₹${Number(bill.discountPerKg).toFixed(2)}/kg`
                      : "-"}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                    ...
                    <div className="space-y-1">
                      ...
                      {bill.paymentType === "partial" && (
                        <div className="text-xs text-gray-500">
                          ...
                          <div>
                            Balance: ₹{Number(bill.balanceAmount).toFixed(2)}
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <Button
                      ...
                      disabled={!isAdmin && bill.paymentType !== "partial"}
                    >
        ...
        {bills.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              No bills have been generated today.
            </p>
          </div>
        )}
      </div>
